...
class ElectricidadPage extends StatefulWidget {
  const ElectricidadPage({super.key});

  @override
  State<ElectricidadPage> createState() => _ElectricidadPageState();
}

class _ElectricidadPageState extends State<ElectricidadPage> {
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                  '${r.kwhConsumption.toStringAsFixed(1)} kWh · Total ${formatMoney(r.totalToPay)} · ${r.status}',
                                        ...
                                        children: [
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              context.read<AppDataCubit>().updateElectricity(
                                                ElectricityRecord(
                                                  id: r.id,
                                                  year: r.year,
                                                  month: r.month,
                                            ...
                                            onPressed: () async {
                                              final ok = await showDialog<bool>(
                                                ...
                                                builder: (ctx) => AlertDialog(
                                                  ...
                                                  content: const Text(
                                                    '¿Eliminar este registro de electricidad?',
                                                  ),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
