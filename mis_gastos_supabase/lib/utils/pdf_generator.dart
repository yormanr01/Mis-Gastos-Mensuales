  ...
  static Future<void> generateMonthlySummary({
    ...
    try {
      ...
      try {
        ...
        print('[PdfGenerator] Error cargando Google Fonts, usando fuentes estándar: $e');
              ...
              pw.Container(
                ...
                child: pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      formatMoney(total),
                      style: pw.TextStyle(font: fontBold, fontSize: 22, color: PdfColors.blue900),
                    ),
                  ],
                ),
              ),
              ...
              if (electricity != null) ...[
                pw.Container(
                  ...
                  decoration: const pw.BoxDecoration(
                    border: pw.Border(left: pw.BorderSide(color: PdfColors.blueGrey200, width: 2)),
                  ),
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text(
                        ...
                        style: pw.TextStyle(font: fontBold, fontSize: 7, color: PdfColors.blueGrey400),
                      ),
                      pw.SizedBox(height: 2),
                      pw.Text(
                        'Total = ((Lectura Actual - Lectura Anterior) x Precio kWh) - Descuento',
                        style: pw.TextStyle(font: font, fontSize: 8, color: PdfColors.blueGrey700),
                      ),
                    ],
                  ),
                ),
      ...
      child: pw.Column(
        ...
        children: [
          pw.Row(
            ...
            children: [
              ...
              pw.Container(
                ...
                height: 6,
                decoration: pw.BoxDecoration(
                  color: status == 'Pagado' ? PdfColors.green : PdfColors.orange,
          ...
          pw.Text(
            ...
            style: pw.TextStyle(font: bold, fontSize: 14, color: PdfColors.blueGrey900),
          ),
          if (details != null) ...[
